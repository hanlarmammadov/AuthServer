...
{  
    public class UserDataAndContactsEditValidationStrategy : FluentValidatorBasedStrategy<CreateUserModel>, IValidationStrategy<CreateUserModel>
    {
        private readonly IValidationStrategy<ContactModel> _newContactValidationStrategy;

        public UserDataAndContactsEditValidationStrategy(IValidationStrategy<ContactModel> newContactValidationStrategy)
        {
